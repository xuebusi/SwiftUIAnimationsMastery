                    ...
                    HStack(spacing: 20) {
                        VStack(spacing: 25) {
                            Text("Stats")
                                .fontWeight(.thin)
                                .padding()
                            Button(action: {}) { Image("stopwatch").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                            Button(action: {}) { Image("heart.rate").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                            Button(action: {}) { Image("scale").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                        }
                        ...
                        VStack(spacing: 25) {
                            Text("Exercise")
                                .fontWeight(.thin)
                                .padding()
                            Button(action: {}) { Image("jump.rope").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                            Button(action: {}) { Image("dumbbell").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                            Button(action: {}) { Image("kettlebell").foregroundStyle(Color.white) }.buttonStyle(ButtonStyleThinOutline())
                        }
                        .frame(maxWidth: .infinity, maxHeight: 500)
